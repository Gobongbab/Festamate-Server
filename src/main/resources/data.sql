...
VALUES ('같이 축제 갈 사람 구함!', '학교 앞 광장', '저녁 7시에 만나서 같이 공연봐요.', 'MATCHING', 4, 'ANY', '20', '23',
        '2025-05-15 19:00:00', 1),
       ('저녁 같이 먹고 푸드트럭 가실 분', '학생회관 앞', '6시쯤 만나서 저녁 먹고 푸드트럭 구경 가요!', 'MATCHING', 3, 'ANY', '21',
       ...
       ('주점 같이 갈 메이트 (아무나)', '주점 거리', '왁자지껄 주점에서 같이 한잔해요!', 'MATCHING', 6, 'ANY', '19', '24',
        '2025-05-17 21:00:00', 6),
       ('동아리 공연 응원 갈 파티원 모집', '동아리 부스 거리', '우리 동아리 공연 보러 같이 가요~', 'MATCHING', 5, 'ANY', '20', '25',
        '2025-05-16 15:00:00', 7),
       ('낮에 플리마켓 구경할 메이트', '중앙 도서관 앞', '아기자기한 플리마켓 구경하고 커피 마셔요.', 'MATCHING', 2, 'FEMALE', '22',
        '25', '2025-05-17 14:00:00', 8),
       ('밤샘 주점팟 구합니다!', '상경대 주점', '밤새 신나게 놀 사람 여기 붙어라~', 'MATCHING', 4, 'ANY', '19', '22',
        '2025-05-16 22:00:00', 9),
       ('조용히 야경 보며 맥주 마실 분', '옥상 정원', '축제 야경 보면서 조용히 맥주 한 잔 해요.', 'MATCHING', 2, 'ANY', '20', '23',
        '2025-05-17 22:30:00', 10),
       ('연예인 무대 같이 볼 사람!', '대운동장 메인 스테이지', '가수 OOO 무대 같이 앞에서 봐요!', 'MATCHING', 3, 'ANY', '20', '24',
        '2025-05-18 20:00:00', 11),
       ('축제 첫날 같이 시작할 메이트!', '정문 앞', '오후 3시에 만나서 축제 전체적으로 훑어봐요.', 'MATCHING', 4, 'ANY', '23', '25',
       ...
       ('점심으로 푸드트럭 도장깨기 할 파티', '푸드트럭 존', '여러 푸드트럭 음식 나눠먹어요!', 'MATCHING', 4, 'ANY', '20', '25',
       ...
       ('불꽃놀이 명당에서 같이 볼 사람', '본관 뒤 언덕', '불꽃놀이 잘 보이는 곳에서 같이 봐요!', 'MATCHING', 4, 'ANY', '19', '25',
        '2025-05-18 21:30:00', 18),
       ('축제 마지막 날 마무리 주점팟', '인문대 주점', '마지막 날 아쉬움을 달래며 한잔!', 'MATCHING', 6, 'ANY', '20', '23',
        '2025-05-18 20:30:00', 19),
       ('사진 찍으면서 축제 구경할 메이트', '캠퍼스 전역', '예쁜 스팟에서 서로 사진 찍어주며 구경해요.', 'MATCHING', 2, 'FEMALE', '20',
        '24', '2025-05-17 15:00:00', 20),
       ('DJ 파티 같이 즐길 사람! (텐션 UP)', '대운동장 특설무대', 'EDM 파티 신나게 같이 즐겨요!', 'MATCHING', 5, 'ANY', '19',
        '23', '2025-05-17 23:00:00', 21),
       ('선배/후배랑 같이 놀아요 (20-22학번)', '학생회관 라운지', '20~22학번끼리 모여서 편하게 얘기하고 놀아요.', 'MATCHING', 4, 'ANY',
        '20', '22', '2025-05-16 17:00:00', 21),
       ('복학생들끼리 모여봅시다!', '복학생 쉼터(?)', '오랜만에 학교 축제 즐기는 복학생들 모여요!', 'MATCHING', 3, 'ANY', '18', '20',
       ...
       ('졸업 전에 마지막 축제 즐기실 분', '어디든 좋아요', '곧 졸업인데 마지막 축제 후회없이 놀아요!', 'MATCHING', 4, 'ANY', '19',
        '21', '2025-05-16 19:00:00', 4),
       ('영화 상영회 같이 볼 사람', '시청각실', '밤에 하는 영화 상영회 같이 봐요.', 'MATCHING', 2, 'ANY', '20', '25',
        '2025-05-17 22:00:00', 5),
       ('굿즈 쇼핑 메이트 구함', '굿즈 판매 부스', '축제 기념 굿즈 같이 구경하고 사요!', 'MATCHING', 2, 'FEMALE', '22', '25',
        '2025-05-18 14:00:00', 6),
       ('저녁 공연 전까지 시간 때울 분', '카페테리아', '저녁 공연 전에 만나서 수다 떨어요.', 'MATCHING', 3, 'ANY', '21', '23',
        '2025-05-16 17:30:00', 7),
       ('새내기들끼리 모여서 놀아요!', '새내기 부스 앞', '25학번 새내기들 모여서 친해져요!', 'MATCHING', 6, 'ANY', '25', '25',
        '2025-05-17 13:00:00', 8),
       ('조용히 산책하며 축제 분위기 느낄 분', '캠퍼스 산책로', '시끄러운 곳 피해 조용히 산책해요.', 'MATCHING', 2, 'ANY', '20', '24',
        '2025-05-18 17:00:00', 9),
       ('보드게임 부스 같이 갈 사람!', '동아리 부스 거리', '보드게임 하면서 시간 보내요~', 'MATCHING', 4, 'ANY', '20', '25',
