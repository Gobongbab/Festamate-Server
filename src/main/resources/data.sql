...
INSERT INTO member (kakao_id, is_profile_completed, name, nickname, student_id, phone_number,
                    ...
                    role, status, token)
VALUES (9876543210, true, '이메이트', '축제러버', '20220002', '010-2222-2222', 'FEMALE',
        'BUSINESS_ADMINISTRATION', 2, 1, 2, 'USER', 'ACTIVE', 'fcmToken2'),
       (1112223331, true, '박축제', '축제지기1', '20230003', '010-3333-1111', 'MALE',
        'ELECTRONIC_ENGINEERING', 2, 2, 1, 'USER', 'ACTIVE', 'fcmToken3'),
       (1112223332, true, '최메이트', '메이트 파인더', '20200004', '010-3333-2222', 'FEMALE',
        'KOREAN_LANGUAGE_LITERATURE', 2, 1, 2, 'USER', 'ACTIVE', 'fcmToken4'),
       (1112223333, false, '정페스타', '페스타고고', '20240005', '010-3333-3333', 'MALE',
        'MECHANICAL_ENGINEERING', 2, 2, 1, 'USER', 'ACTIVE', 'fcmToken5'),
       (1112223334, true, '강즐겜', '즐겜유저', '20210006', '010-3333-4444', 'FEMALE', 'CHEMISTRY', 2, 0,
        2, 'USER', 'ACTIVE', 'fcmToken6'),
       (1112223335, true, '조동행', '같이갈래', '20220007', '010-3333-5555', 'MALE', 'PHYSICS', 2, 2, 1,
        'USER', 'ACTIVE', 'fcmToken7'),
       (1112223336, false, '윤신입', '새내기파워', '20250008', '010-3333-6666', 'FEMALE', 'LIFE_SCIENCE', 2,
        2, 2, 'USER', 'ACTIVE', 'fcmToken8'),
       (1112223337, true, '장코드', '코딩마스터', '20190009', '010-3333-7777', 'MALE', 'COMPUTER_SCIENCE',
        3, 3, 1, 'USER', 'ACTIVE', 'fcmToken9'),
       (1112223338, true, '임스터디', '열공모드', '20200010', '010-3333-8888', 'FEMALE', 'MATHEMATICS', 2,
        1, 2, 'USER', 'ACTIVE', 'fcmToken10'),
       (1112223339, true, '한아트', '예술혼', '20210011', '010-3333-9999', 'MALE', 'FINE_ARTS', 2, 2, 1,
        'USER', 'ACTIVE', 'fcmToken11'),
       (1112223340, false, '오뮤직', '음악사랑', '20220012', '010-4444-1111', 'FEMALE', 'MUSIC', 2, 2, 2,
        'USER', 'ACTIVE', 'fcmToken12'),
       (1112223341, true, '서경영', '미래 CEO', '20230013', '010-4444-2222', 'MALE',
        'BUSINESS_ADMINISTRATION', 2, 0, 1, 'USER', 'ACTIVE', 'fcmToken13'),
       (1112223342, true, '신사회', '사회탐구', '20200014', '010-4444-3333', 'FEMALE', 'SOCIOLOGY', 2, 1,
        2, 'USER', 'ACTIVE', 'fcmToken14'),
       (1112223343, true, '권체육', '운동짱', '20210015', '010-4444-4444', 'MALE', 'PHYSICAL_EDUCATION',
        2, 2, 1, 'USER', 'ACTIVE', 'fcmToken15'),
       (1112223344, false, '황지리', '지리박사', '20240016', '010-4444-5555', 'FEMALE', 'GEOGRAPHY', 2, 2,
        2, 'USER', 'ACTIVE', 'fcmToken16'),
       (1112223345, true, '안역사', '역사덕후', '20190017', '010-4444-6666', 'MALE', 'HISTORY', 2, 2, 1,
        'USER', 'ACTIVE', 'fcmToken17'),
       (1112223346, true, '송교육', '참선생', '20200018', '010-4444-7777', 'FEMALE', 'EDUCATION', 2, 1, 2,
        'USER', 'ACTIVE', 'fcmToken18'),
       (1112223347, true, '전법학', '정의구현', '20210019', '010-4444-8888', 'MALE', 'LAW', 2, 0, 1,
        'USER', 'ACTIVE', 'fcmToken19'),
       (1112223348, false, '홍정외', '외교관꿈', '20220020', '010-4444-9999', 'FEMALE',
        'POLITICAL_SCIENCE_DIPLOMACY', 2, 2, 2, 'USER', 'ACTIVE', 'fcmToken20'),
       (1112223349, true, '유디자인', '디자인감각', '20230021', '010-5555-1111', 'MALE', 'DESIGN', 2, 2, 1,
        'USER', 'ACTIVE', 'fcmToken21'),
       (1112223350, true, '고건축', '건축학도', '20200022', '010-5555-2222', 'FEMALE', 'ARCHITECTURE', 2,
        1, 2, 'USER', 'ACTIVE', 'fcmToken22');
...
VALUES ('room_banner_1.jpg', 'uuid_room_banner_1.jpg',
        'http://example.com/images/uuid_room_banner_1.jpg', 1),
       ('room_banner_2.jpg', 'uuid_room_banner_2.jpg',
        'http://example.com/images/uuid_room_banner_2.jpg', 2),
       ('room_banner_3.jpg', 'uuid_room_banner_3.jpg',
        'http://example.com/images/uuid_room_banner_3.jpg', 3),
       ('room_banner_4.jpg', 'uuid_room_banner_4.jpg',
        'http://example.com/images/uuid_room_banner_4.jpg', 4),
       ('room_banner_5.jpg', 'uuid_room_banner_5.jpg',
        'http://example.com/images/uuid_room_banner_5.jpg', 5),
       ('room_banner_6.jpg', 'uuid_room_banner_6.jpg',
        'http://example.com/images/uuid_room_banner_6.jpg', 6),
       ('room_banner_7.jpg', 'uuid_room_banner_7.jpg',
        'http://example.com/images/uuid_room_banner_7.jpg', 7),
       ('room_banner_8.jpg', 'uuid_room_banner_8.jpg',
        'http://example.com/images/uuid_room_banner_8.jpg', 8),
       ('room_banner_9.jpg', 'uuid_room_banner_9.jpg',
        'http://example.com/images/uuid_room_banner_9.jpg', 9),
       ('room_banner_10.jpg', 'uuid_room_banner_10.jpg',
        'http://example.com/images/uuid_room_banner_10.jpg', 10),
       ('room_banner_11.jpg', 'uuid_room_banner_11.jpg',
        'http://example.com/images/uuid_room_banner_11.jpg', 11),
       ('room_banner_12.jpg', 'uuid_room_banner_12.jpg',
        'http://example.com/images/uuid_room_banner_12.jpg', 12),
       ('room_banner_13.jpg', 'uuid_room_banner_13.jpg',
        'http://example.com/images/uuid_room_banner_13.jpg', 13),
       ('room_banner_14.jpg', 'uuid_room_banner_14.jpg',
        'http://example.com/images/uuid_room_banner_14.jpg', 14),
       ('room_banner_15.jpg', 'uuid_room_banner_15.jpg',
        'http://example.com/images/uuid_room_banner_15.jpg', 15),
       ('room_banner_16.jpg', 'uuid_room_banner_16.jpg',
        'http://example.com/images/uuid_room_banner_16.jpg', 16),
       ('room_banner_17.jpg', 'uuid_room_banner_17.jpg',
        'http://example.com/images/uuid_room_banner_17.jpg', 17),
       ('room_banner_18.jpg', 'uuid_room_banner_18.jpg',
        'http://example.com/images/uuid_room_banner_18.jpg', 18),
       ('room_banner_19.jpg', 'uuid_room_banner_19.jpg',
        'http://example.com/images/uuid_room_banner_19.jpg', 19),
       ('room_banner_20.jpg', 'uuid_room_banner_20.jpg',
        'http://example.com/images/uuid_room_banner_20.jpg', 20),
       ('room_banner_21.jpg', 'uuid_room_banner_21.jpg',
        'http://example.com/images/uuid_room_banner_21.jpg', 21),
       ('room_banner_22.jpg', 'uuid_room_banner_22.jpg',
        'http://example.com/images/uuid_room_banner_22.jpg', 22),
       ('room_banner_23.jpg', 'uuid_room_banner_23.jpg',
        'http://example.com/images/uuid_room_banner_23.jpg', 23),
       ('room_banner_24.jpg', 'uuid_room_banner_24.jpg',
        'http://example.com/images/uuid_room_banner_24.jpg', 24),
       ('room_banner_25.jpg', 'uuid_room_banner_25.jpg',
        'http://example.com/images/uuid_room_banner_25.jpg', 25),
       ('room_banner_26.jpg', 'uuid_room_banner_26.jpg',
        'http://example.com/images/uuid_room_banner_26.jpg', 26),
       ('room_banner_27.jpg', 'uuid_room_banner_27.jpg',
        'http://example.com/images/uuid_room_banner_27.jpg', 27),
       ('room_banner_28.jpg', 'uuid_room_banner_28.jpg',
        'http://example.com/images/uuid_room_banner_28.jpg', 28),
       ('room_banner_29.jpg', 'uuid_room_banner_29.jpg',
        'http://example.com/images/uuid_room_banner_29.jpg', 29),
       ('room_banner_30.jpg', 'uuid_room_banner_30.jpg',
        'http://example.com/images/uuid_room_banner_30.jpg', 30),
       ('room_banner_31.jpg', 'uuid_room_banner_31.jpg',
        'http://example.com/images/uuid_room_banner_31.jpg', 31);
