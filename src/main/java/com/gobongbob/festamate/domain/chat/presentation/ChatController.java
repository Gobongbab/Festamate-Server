...
public class ChatController {
    ...
    public ResponseEntity<ChatResponse> chat(@DestinationVariable Long roomId, ChatRequest request) {

        return ResponseEntity.ok(chatService.createChat(request, roomId));
    }
}
